...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'Breadcumbs Plus', // The plugin name
			'slug'     				=> 'breadcrumbs-plus', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory_uri() . '/framework/includes/plugins/breadcrumbs-plus.zip', // The plugin source
