<?php
	...
	function sys_flash($atts, $content = null) {
		...
		$out = '<div class="video-stage" style="width:'.$width.'px; height:'.$height.'px">
				...
				<param name="expressInstaller" value="'.THEME_URI.'/swf/expressInstall.swf"></param>
	...
	function sys_youtube($atts, $content = null) {
		...
		return '<div class="video-stage">
			<iframe width='.$width.' height='.$height.' src="http://www.youtube.com/embed/'.$clipid.'?autohide='.$autohide.'&amp;autoplay='.$autoplay.'&amp;controls='.$controls.'&amp;disablekb='.$disablekb.'&amp;fs='.$fs.'&amp;hd='.$hd.'&amp;loop='.$loop.'&amp;rel='.$rel.'&amp;showinfo='.$showinfo.'&amp;showsearch='.$showsearch.'&amp;wmode=transparent" width='.$width.' height='.$height.' frameborder="0"></iframe>
			</div>';
	}
	...
	// W O R D P R E S S T V   V I D E O 
	//--------------------------------------------------------
