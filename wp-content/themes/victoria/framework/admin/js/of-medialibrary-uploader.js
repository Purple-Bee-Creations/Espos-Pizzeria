	...
	window.send_to_editor = function(html) {
		...
		if (formfield) {
          ...
          if (itemurl.match(image)) {
            btnContent = '<img src="'+itemurl+'" alt="" /><a href="#" class="custom_clear_image_button button button-primary green-button">X</a>';
          } else {
            ...
            btnContent = '<div class="no_image"><span class="file_link">'+html+'</span><a href="#" class="custom_clear_image_button">Remove</a></div>';
          }
