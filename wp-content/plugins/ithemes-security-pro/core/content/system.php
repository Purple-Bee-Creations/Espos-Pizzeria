...
<li>
	...
	<ul>
		<li><?php _e( 'MySQL Database Version', 'it-l10n-ithemes-security-pro' ); ?>
			: <?php $sqlversion = $wpdb->get_var( "SELECT VERSION() AS version" ); ?>
			<strong><?php echo $sqlversion; ?></strong></li>
		<li><?php _e( 'MySQL Client Version', 'it-l10n-ithemes-security-pro' ); ?>: <strong><?php echo mysql_get_client_info(); ?></strong></li>
		<li><?php _e( 'Database Host', 'it-l10n-ithemes-security-pro' ); ?>: <strong><?php echo DB_HOST; ?></strong></li>
		<li><?php _e( 'Database Name', 'it-l10n-ithemes-security-pro' ); ?>: <strong><?php echo DB_NAME; ?></strong></li>
		<li><?php _e( 'Database User', 'it-l10n-ithemes-security-pro' ); ?>: <strong><?php echo DB_USER; ?></strong></li>
		...
		if ( empty( $sql_mode ) ) {
			...
			$sql_mode = __( 'Off', 'it-l10n-ithemes-security-pro' );
		}
		?>
		<li><?php _e( 'SQL Mode', 'it-l10n-ithemes-security-pro' ); ?>: <strong><?php echo $sql_mode; ?></strong></li>
	</ul>
</li>
...
<li>
	...
	<ul>
		...
		<li><?php _e( 'Wp-config Location', 'it-l10n-ithemes-security-pro' ); ?>: <strong><?php echo $config_file ?></strong></li>
